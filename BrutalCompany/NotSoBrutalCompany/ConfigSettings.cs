...
namespace NotSoBrutalCompany
{
    public class ConfigSettings
    {
        ...
        public void LoadConfigs()
        {
            ...
            EventProbability = Plugin.instance.Config.Bind<int>("Events", "EventProbablity", 0 , "Value from 0 to 10. 0 there's almost always an event and 10 there's never an event.");
